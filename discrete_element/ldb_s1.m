...
'Parent',h1,...
'Box','on',...
'CameraPosition',[0.0515463917525775 225000000 17.3205080756888],...
...
'LineWidth',0.5,...
'Margin',2,...
'Position',[0.0514276212646683 458552631.578947 1.00010919874411],...
'Rotation',0,...
'String',blanks(0),...
'Interpreter','tex',...
...
'LineWidth',0.5,...
'Margin',2,...
'Position',[0.0514276212646683 -30921052.631579 1.00010919874411],...
'Rotation',0,...
'String','Axial Strain',...
'Interpreter','tex',...
...
'LineWidth',0.5,...
'Margin',2,...
'Position',[-0.00676991781082239 223026315.789474 1.00010919874411],...
'Rotation',90,...
...
'LineWidth',0.5,...
'Margin',2,...
'Position',[-0.0174592617226472 490131578.947368 1.00010919874411],...
'Rotation',0,...
'String',blanks(0),...
'Interpreter','tex',...
...
h20 = scribe.legend(...
'Parent',h1,...
'Position',[0.719345238095238 0.475 0.176785714285714 0.431746031746032],...
'Box','on',...
...
'UserData',struct(...
    'PlotHandle', [], ...
    'legendpos', 1, ...
    'LegendPosition', [0.719345238095238 0.475 0.176785714285714 0.431746031746032], ...
    'LabelHandles', [], ...
    'handles', [], ...
