...
'Parent',h1,...
'Box','on',...
'CameraPosition',[45 425 17.3205080756888],...
...
'LineWidth',0.5,...
'Margin',2,...
'Position',[44.8859447004608 866.154970760234 1.00010919874411],...
'Rotation',0,...
'String',blanks(0),...
'Interpreter','tex',...
...
'LineWidth',0.5,...
'Margin',2,...
'Position',[44.8859447004608 -58.406432748538 1.00010919874411],...
'Rotation',0,...
...
'LineWidth',0.5,...
'Margin',2,...
'Position',[-11.6854838709677 421.271929824561 1.00010919874411],...
'Rotation',90,...
...
'LineWidth',0.5,...
'Margin',2,...
'Position',[-21.2661290322581 925.804093567251 1.00010919874411],...
'Rotation',0,...
'String',blanks(0),...
'Interpreter','tex',...
...
h13 = scribe.legend(...
'Parent',h1,...
'Position',[0.143154761904762 0.811507936507936 0.176785714285714 0.0952380952380952],...
'Box','on',...
...
'UserData',struct(...
    'PlotHandle', [], ...
    'legendpos', 2, ...
    'LegendPosition', [0.143154761904762 0.811507936507936 0.176785714285714 0.0952380952380952], ...
    'LabelHandles', [], ...
    'handles', [], ...
