...
'Parent',h1,...
'Box','on',...
'CameraPosition',[45 3250 17.3205080756888],...
...
'LineWidth',0.5,...
'Margin',2,...
'Position',[44.8859447004608 6623.53801169591 1.00010919874411],...
'Rotation',0,...
'String',blanks(0),...
'Interpreter','tex',...
...
'LineWidth',0.5,...
'Margin',2,...
'Position',[44.8859447004608 -446.637426900585 1.00010919874411],...
'Rotation',0,...
...
'LineWidth',0.5,...
'Margin',2,...
'Position',[-13.2822580645161 3221.49122807018 1.00010919874411],...
'Rotation',90,...
...
'LineWidth',0.5,...
'Margin',2,...
'Position',[-21.2661290322581 7079.6783625731 1.00010919874411],...
'Rotation',0,...
'String',blanks(0),...
'Interpreter','tex',...
...
h13 = scribe.legend(...
'Parent',h1,...
'Position',[0.719345238095238 0.806746031746032 0.176785714285714 0.1],...
'Box','on',...
...
'UserData',struct(...
    'PlotHandle', [], ...
    'legendpos', 1, ...
    'LegendPosition', [0.719345238095238 0.806746031746032 0.176785714285714 0.1], ...
    'LabelHandles', [], ...
    'handles', [], ...
