...
layer_order0=[2 2 3 2 2];  %approximate to mineralogy fractions in core
layer_order00=[2 2 3 2 2];  %approximate to mineralogy fractions in core
layer_order000=[2 2 3 2 2];  %approximate to mineralogy fractions in core
...
[babyseed, baby_l]=makefiller(smallest_grain, seql, seed_bed_thickness, eps);
...
%%
function [babyseed, baby_l]=makefiller(gtype,len,t,sigma)
