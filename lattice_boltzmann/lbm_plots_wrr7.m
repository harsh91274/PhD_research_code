...
set(nm_legend,'FontName','Helvetica'); hold on;
...
set(gcf,'Color','w');
export_fig f4 wrr6b_f4_k_het -q101 -painters -nocrop -pdf -png -tiff -eps 
%%
f1=figure(1);
set(gcf,'Color','w');
n_orig=fill(k_neuzil(3:13,2),k_neuzil(3:13,1),[0.91 0.91 0.91],'edgecolor','none'); %1
...
set(neuzil_legend,'FontName','Helvetica'); hold on;
set(neuzil_legend, 'FontSize',6); hold on; 
legend boxon
% resize_legend(neuzil_legend,1);
set([xl3, yl3],'FontName','Helvetica');
set(gcf,'Color','w');
box on
export_fig f1 wrr6b_f2_kcomp_neuzil -q101 -painters -nocrop -pdf -png -tiff -eps 
%%
f5=figure(5);
set(gcf,'Color','w');
n_orig=fill(k_neuzil(3:13,2),k_neuzil(3:13,1),[0.91 0.91 0.91],'edgecolor','none'); %1
...
set(neuzil_legend2,'FontSize',6);
set(neuzil_legend2,'FontName','Helvetica');
legend boxon
set([xl3, yl3],'FontName','Helvetica');
set(gcf,'Color','w');
box on
export_fig f2 wrr6b_f6_k_fracture -q101 -painters -nocrop -pdf -png -tiff -eps 
%%
% f9=figure(9);
...
set(t_legend,'FontName','Helvetica');
% set(t_legend,'position',[ 0.6256 0.3 0.2696 0.22]); 
set([xl2, yl2],'FontName','Helvetica');
set(gcf,'Color','w');
...
t7_legend2=legend([t_kaolinite, t_comp, t_smectite],'Kaolinite Model', 'Intermediate Mudstone Model', 'Smectite Model', 'location','northeast'); 
set(t7_legend2,'FontSize',8);
set(t7_legend2,'FontName','Helvetica');
legend boxon
% set(t_legend,'position',[ 0.6256 0.3 0.2696 0.22]); 
set([xl7, yl7],'FontName','Helvetica');
set(gcf,'Color','w');
export_fig f7 wrr6b_fS2a_t_homo -pdf -png -eps -tiff -q101 -nocrop
...
set(rat_legend,'FontName','Helvetica');
set([xl3, yl3],'FontName','Helvetica');
set(gcf,'Color','w');
...
set(rat2_legend,'FontName','Helvetica');
set([xl4, yl4],'FontName','Helvetica');
set(gcf,'Color','w');
% saveas(gcf,'d6_f5_ratios','eps');
...
set(t2_legend,'FontName','Helvetica');
% set(t_legend,'position',[ 0.6256 0.3 0.2696 0.22]); 
set([xl5, yl5],'FontName','Helvetica');
set(gcf,'Color','w');
