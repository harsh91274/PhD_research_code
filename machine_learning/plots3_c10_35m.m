...
% axis tight;
xlim([0 max(strain10)]);
ylabel ('Shear Fraction', 'fontsize', 8);
...
xlabel('Axial Strain');
yyaxis(s1,'right');
plot(s1,strain10,b_value10,'linewidth',2); hold on; 
% axis tight;
box on
xlim([0 max(strain10)]);
...
b_proxy=nan(10,1);d_proxy=nan(10,1);
...
s1=subplot(2,1,1);
yyaxis(s1,'left');
% plot(s1,time_all,stress10_t./10^6,'linewidth',2); hold on; 
% axis tight; 
% ylabel('Axial tress (MPa)', 'fontsize', 8); 
xlabel('Axial Strain');
% yyaxis(s1,'right');
plot(s1,time_all,d_value10_t,'linewidth',2); hold on; 
box on
% axis tight;
% xlim([0 max(strain10)]);
xlim([0 max(time_all)]);
ylabel ('D_value', 'fontsize', 8);
% legend(s1,'Microcrack Rate', 'Microcrack Shear Fraction','Location','NorthEast','fontsize',6);
...
% xlabel('Axial Strain');
% yyaxis(s2,'right');
plot(time_all,b_value10_t,'linewidth',2); hold on; 
% axis tight;
box on
xlim([0 max(time_all)]);
ylabel ('b-value', 'fontsize', 8);
...
set(gcf,'Color','w'); 
export_fig f411 f411_10mpa_time_bD -q101 -painters -nocrop -pdf -png -tiff -eps 
%%
%35 mpa composites
e_kur35=data35(:,26);
mc_var35=data35(:,21);
...
% xlabel('Axial Strain');
yyaxis(s2,'left');
plot(strain35,d_value35,'linewidth',2); hold on; 
% axis tight;
box on
xlim([0 max(strain35)]);
ylabel ('D-value', 'fontsize', 8);
...
xlabel('Axial Strain');
yyaxis(s1,'right');
plot(s1,strain35,b_value35,'linewidth',2); hold on; 
% axis tight;
box on
xlim([0 max(strain35)]);
ylabel ('b-value', 'fontsize', 8);
...
%%
%10 mpa b, D plots
data10b=xlsread('p3_data_binned4.xlsx','10b');
data10d=xlsread('p3_data_binned4.xlsx','10d');
f_cmap3=linspecer(4);
...
% xlabel('Axial Strain');
% yyaxis(s2,'right');
plot(strain25,d_value25,'linewidth',2); hold on; 
% axis tight;
box on
xlim([0 max(strain25)]);
ylabel ('D-value', 'fontsize', 8);
...
xlabel('Axial Strain');
yyaxis(s1,'right');
plot(s1,strain25,b_value25,'linewidth',2); hold on; 
% axis tight;
box on
xlim([0 max(strain25)]);
ylabel ('b-value', 'fontsize', 8);
