...
%%
%10 mpa
data10=xlsread('p3_data_binned3.xlsx','10mpa');
strain10=data10(:,29);
mc_rate10=data10(:,23);
...
%%
%5 mpa
data5=xlsread('p3_data_binned3.xlsx','5mpa');
strain5=data5(:,29);
mc_rate5=data5(:,23);
...
%%
%0 mpa
data0=xlsread('p3_data_binned3.xlsx','0mpa');
strain0=data0(:,29);
mc_rate0=data0(:,23);
...
%%
%15 mpa
data15=xlsread('p3_data_binned3.xlsx','15mpa');
strain15=data15(:,29);
mc_rate15=data15(:,23);
...
%%
%20 mpa
data20=xlsread('p3_data_binned3.xlsx','20mpa');
strain20=data20(:,29);
mc_rate20=data20(:,23);
...
%%
%25 mpa
data25=xlsread('p3_data_binned3.xlsx','25mpa');
strain25=data25(:,29);
mc_rate25=data25(:,23);
...
%%
%30 mpa
data30=xlsread('p3_data_binned3.xlsx','30mpa');
strain30=data30(:,29);
mc_rate30=data30(:,23);
...
%%
%35 mpa
data35=xlsread('p3_data_binned3.xlsx','35mpa');
strain35=data35(:,29);
mc_rate35=data35(:,23);
...
%%
%40 mpa
data40=xlsread('p3_data_binned3.xlsx','40mpa');
strain40=data40(:,29);
mc_rate40=data40(:,23);
...
%%
%45 mpa
data45=xlsread('p3_data_binned3.xlsx','45mpa');
strain45=data45(:,29);
mc_rate45=data45(:,23);
...
%%
%50 mpa
data50=xlsread('p3_data_binned3.xlsx','50mpa');
strain50=data50(:,29);
mc_rate50=data50(:,23);
