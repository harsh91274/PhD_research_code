...
%removing evar
i0=[cp0, mc_var0, shear_fraction0, b_value0, d_value0];
i5=[cp5, mc_var5, shear_fraction5, b_value5, d_value5];
i10=[cp10, mc_var10, shear_fraction10, b_value10, d_value10];
i15=[cp15, mc_var15, shear_fraction15, b_value15, d_value15];
i20=[cp20, mc_var20, shear_fraction20, b_value20, d_value20];
i30=[cp30, mc_var30, shear_fraction30, b_value30, d_value30];
i35=[cp35, mc_var35, shear_fraction35, b_value35, d_value35];
i40=[cp40, mc_var40, shear_fraction40, b_value40, d_value40];
i45=[cp45, mc_var45, shear_fraction45, b_value45, d_value45];
i50=[cp50, mc_var50, shear_fraction50, b_value50, d_value50];
...
i25=[cp25, mc_var25, shear_fraction25, b_value25, d_value25];
...
o_50t_strain_tf=strain_tf50;
o_50t_cp=cp50;
%%
% run p3_prediction_RF4
