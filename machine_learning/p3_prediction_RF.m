...
stress_swf=[b1, se1, pval1, inmodel1'];
dlmwrite('stress_swf.dat', stress_swf);
%C1 = coefficients 
%C2 = std error
%C3 = pvalue
%C4 = Inmodel (1=yes)
...
box on
legend('Testing Set', 'Predictions','location','best');
set(gcf,'color','w');
...
xticklabels({'S_{3}', 'MC_{var}', 'SF', 'E_{var}', 'b', 'D'});
hold on
