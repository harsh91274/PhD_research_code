...
set(gcf,'color','w');
export_fig f1_r ANN_strain_regression -pdf -png -eps -tiff -dsvg -q101 -nocrop
%%
%locate indexes for plotting
strain_all=[strain0; strain5; strain10; strain15; strain20; strain30; strain35; strain40; strain45; strain50];
...
axis tight; xlabel('Axial Strain'); ylabel (' Strain to Failure'); 
box on
...
export_fig f2 ANN_strain_tvt -pdf -png -eps -tiff -dsvg -q101 -nocrop
%%
%25 mpa testing
targets1_25=o_25t_strain_tf;
...
p25=plot(strain25, targets1_25, 'o', 'markersize',4,'color',f_cmap12(1,:)); hold on;
test_p25=plot(strain25, outputs1_25, 's', 'markersize',4,'color',f_cmap12(3,:),'linewidth',2.5); hold on;
axis tight; xlabel('Axial Strain'); ylabel ('Output: Axial Strain to Failure'); 
yyaxis right
test_s25=plot(strain25, data25(:,39)./10^6,'linewidth',2); hold on;
ylabel('Axial Stress (MPa)'); hold on;
box on
legend('Testing Set', 'Predictions','location','southeast');
set(gcf,'color','w');
export_fig f3 ANN_Strain_test25 -pdf -png -eps -tiff -dsvg -q101 -nocrop
...
p50=plot(strain50, targets1_50, 'o', 'markersize',4,'color',f_cmap12(1,:),'linewidth',1.5); hold on;
test_p50=plot(strain50, outputs1_50, 's', 'markersize',4,'color',f_cmap12(3,:),'linewidth',2.5); hold on;
axis tight; xlabel('Axial Strain'); ylabel ('Output: Axial Strain to Failure'); 
yyaxis right
test_s50=plot(strain50, data50(:,39)./10^6,'linewidth',2); hold on;
ylabel('Axial Stress (MPa)'); hold on;
box on
legend('Testing Set', 'Predictions','location','southeast');
set(gcf,'color','w');
export_fig f31 ANN_Strain_test50 -pdf -png -eps -tiff -dsvg -q101 -nocrop
...
xticklabels({'CP', 'MC_{var}', 'SF', 'E_{var}', 'b', 'D'});
hold on
%%
strain_sc=input('Satisfied with Strain-to-Failure Predictions? (1=Yes): ');
if strain_sc==1
    save net1;
else
    close all;
...
axis tight; xlabel('Axial Strain'); ylabel ('Stress to Failure (MPa)'); 
box on
...
set(gcf,'color','w');
saveas(gcf,'strain_tf','fig');
export_fig f5 ANN_stress_tvt -pdf -png -eps -tiff -dsvg -q101 -nocrop
%%
%25 mpa testing
...
f6=figure(6);
title('25 MPa'); hold on;
p25=plot(strain25, targets2_25, 'o', 'markersize',4,'color',f_cmap12(1,:),'color','b'); hold on;
test_p25=plot(strain25, outputs2_25, 's', 'markersize',4,'color',f_cmap12(3,:),'linewidth',2.5); hold on;
axis tight; xlabel('Axial Strain'); ylabel ('Output: Axial Stress to Failure (MPa)'); 
yyaxis right
test_s25=plot(strain25, data25(:,39)./10^6,'linewidth',2); hold on;
ylabel('Axial Stress (MPa)'); hold on;
box on
legend('Testing Set', 'Predictions','location','southeast');
set(gcf,'color','w');
export_fig f6 ANN_Stress_test25 -pdf -png -eps -tiff -dsvg -q101 -nocrop
...
f61=figure(61);
title('50 MPa'); hold on;
p50=plot(strain50, targets2_50, 'o', 'markersize',4,'color',f_cmap12(1,:),'color','b'); hold on;
test_p50=plot(strain50, outputs2_50, 's', 'markersize',4,'color',f_cmap12(3,:),'linewidth',2.5); hold on;
axis tight; xlabel('Axial Strain'); ylabel ('Output: Axial Stress to Failure (MPa)'); 
yyaxis right
test_s50=plot(strain50, data50(:,39)./10^6,'linewidth',2); hold on;
ylabel('Axial Stress (MPa)'); hold on;
...
legend('Testing Set', 'Predictions','location','southeast');
set(gcf,'color','w');
export_fig f61 ANN_Stress_test50 -pdf -png -eps -tiff -dsvg -q101 -nocrop
