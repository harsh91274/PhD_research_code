...
plot(strain_tf50,e_rate50,'linewidth',2,'color',f_cmap(4,:)); hold on;
% xlim([0 max(strain_tf45)]);
xlim([min(strain_tf50) max(strain_tf50)]);
ylabel('Microcrack Energy Rate'); 
xlabel('Axial Strain to failure');
legend('0 MPa', '20 MPa','50 MPa','location','best','fontsize',9);
...
plot(stress_tf50,e_rate50,'linewidth',2,'color',f_cmap(4,:)); hold on;
xlim([min(stress_tf50) max(stress_tf50)]);
ylabel('Microcrack Energy Rate'); 
xlabel('S1 to failure (MPa)');
legend('0 MPa', '20 MPa','50 MPa','location','best','fontsize',9);
...
ylabel('D-value'); 
xlabel('Axial Strain to failure');
legend('0 MPa','20 MPa','56 MPa','location','best','fontsize',9);
set(gcf,'Color','w'); 
...
xlim([min(stress_tf45) max(stress_tf0)]);
ylabel('D-value'); 
xlabel('S1 to failure (MPa)');
legend('0 MPa', '20 MPa','45 MPa','location','best','fontsize',9);
set(gcf,'Color','w'); 
